-- =============================================================================
--          DSA PLATFORM v2 - FINAL PRODUCTION-READY SCHEMA
--
...
--=============================================================================
-- 1. AUTHENTICATION & AUTHORIZATION SCHEMA (`dsa_auth`)
--=============================================================================
...
CREATE TABLE IF NOT EXISTS dsa_core.datasets (
    ...
    description TEXT,
    created_by INT REFERENCES dsa_auth.users(id) ON DELETE SET NULL, -- Cross-schema reference
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS dsa_core.commits (
    ...
    message TEXT,
    author_id INT REFERENCES dsa_auth.users(id) ON DELETE SET NULL, -- Cross-schema reference
